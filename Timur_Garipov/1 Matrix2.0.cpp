...
public:
    ...
    RowOfMatrix operator[](int n) {
        n--;
        int size = this->getDimension();
        if (n < 0 || n >= size) throw "Ќе существует строки с таким номером";
...
matrix operator+(matrix c1, matrix c2) {
    ...
    throw std::string("—ложение матриц разного размера!");
}
...
matrix operator-(matrix c1, matrix c2) {
    ...
    throw std::string("¬ычитание матриц разного размера!");
}
...
matrix operator*(matrix c1, matrix c2) {
    ...
    throw std::string("”множение матриц разного размера!");
}
...
bool operator==(matrix c1, matrix c2) {
    ...
    throw std::string("—равнение матриц разного размера!");
}
...
matrix operator+(matrix c1) {
    int size = c1.getDimension();
    if (size == 0)
        throw std::string("“ранспонирование матрицы нулевого размера!");
